# QVAC Fake Lost Pet Flyer Generator

Type a pet's personality and an on-device AI writes a heartfelt lost pet flyer description for it, with a deterministic worry meter.
...
Then open http://localhost:29475
